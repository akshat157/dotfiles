...
Singleton {
    ...
    // Audio
    property string preferredAudioSinkName: adapter.preferredAudioSinkName
    ...
    function serializeConfig() {
        return {
            ...
            preferredAudioSinkName: adapter.preferredAudioSinkName
        };
    }
    ...
    FileView {
        ...
        JsonAdapter { // qmllint disable unresolved-type
            ...
            property string preferredAudioSinkName: ""
        }
    }
}
